...
// quotes.forEach(function(item, index, quotesArray) {
//   console.log(`item, index : ${item.quote} ${item.author} ${index}`);
// });
// for(let quoteObject in quotes) {
//   console.log(`quoteObject.quote : ${quoteObject} ${quotes[quoteObject]}`);
// }
